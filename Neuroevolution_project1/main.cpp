  ...
  /*
    ...
    sort(creatures.begin(), creatures.end(), compare);
        ...
        for(int i=0; i<5; i++){
            ...
            organism* child=new organism(reproduce(*creatures.at(i)->getGenome(), *creatures.at(d)->getGenome()),main);
        ...
        for(int i=5; i<10; i++){
            for(int k=0; k<2;k++){
            organism* child=new organism(reproduce(*creatures.at(i)->getGenome(), *creatures.at(uniformTest(5, 20, 1))->getGenome()),main);
            creatures.push_back(child);
            }
        }
 ...
 */
    ...
    int array[34]={55,55,55,55,55,55,22,22,22,33,22,55,33,2,3,3,3,2,33,98,55,5,55,55,55,55,98,33,67,77,76,76, 55,55};
     for(int i=0; i<1000; i++){
