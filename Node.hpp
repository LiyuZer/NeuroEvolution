...
//
    ...
    void setThreadID(int d)const {
        thread_ID=d;
    }
    double getThreadID()const {
        return thread_ID;
    }
...
public:
   collection_node(int index, Network<Node>* n, bool dynamic, int threadID)
    ...
    collection_node(Network<Node>* n, bool dynamic, int threadID)
    :Node(0,false,n, dynamic, threadID)
    {
...
//            this->printInfo(this);
    ...
    void activate() override{
        ...
        getInputVector()->push_back(1);//Once there is an activation the input doesn't matter, take this out for regular use
        ...
        vector<Node*>* nextVector= this->getNextVector();
         for(int i=0; i<nextVector->size(); i=i+1){
             ...
             if(nextVector->at(i)->get_is_collective_node()){
                 ...
                 nextVector->at(i)->getInputVector()->at(0)=nextVector->at(i)->getInputVector()->at(0)+(getOutputVector()->at(0));
             }
         }
    }
...
public:
    ...
    value_node(bool val, Network<Node>* n, bool dynamic, int threadID)
    :Node(0,true, n, dynamic, threadID){
    ...
    value_node(Network<Node>* n, bool dynamic, int threadID)
    :Node(0,true, n, dynamic, threadID)
    {
...
//        c->activate();
       ...
       value_node* sum_pointer= new value_node (this->getInput(0)+right.getInput(0),&right, right.getNetworkPointer(), true,this->getThreadID());
...
//    }
    ...
    value_node& operator&(double right){
        ...
        value_node* sum_pointer= new value_node (pow(exp(1),this->getInput(0)),this, this->getNetworkPointer(), true, this->getThreadID());
        this->addNext(sum_pointer);
        this->addOutput(this->getInput(0));
    ...
    value_node& operator%(double right){
        value_node* sum_pointer= new value_node (log(this->getInput(0)),this, this->getNetworkPointer(), true, this->getThreadID());
...
//        c->activate();
    ...
    virtual value_node& operator*(value_node& right) {
        ...
        value_node* sum_pointer= new value_node (this->getInput(0)*right.getInput(0),this, right.getNetworkPointer(), true, this->getThreadID());
...
//    }
    ...
    value_node& operator^(double right){
        value_node* sum_pointer= new value_node ((double)pow(this->getInput(0),right),this, this->getNetworkPointer(), true, this->getThreadID());
        ...
        vector<Node*>* nextVector= this->getNextVector();
         for(int i=0; i<nextVector->size(); i=i+1){
             ...
             if(nextVector->at(i)->get_is_collective_node()){
                 ...
                 nextVector->at(i)->getInputVector()->at(0)=nextVector->at(i)->getInputVector()->at(0)+getInputVector()->at(0);
             }
         }
    }
...
public:
    parameter_node(double value, Node* prev, Network<Node>* n, bool dynamic, std::shared_ptr<double[]> pre, int threadID)
    ...
    parameter_node(Network<Node>* n, bool dynamic, int threadID)
    : value_node(true, n, dynamic, threadID)
    {
        setTrueParamter();
...
//            this->printInfo(this);
    ...
    virtual double getInput(int index) override{
        return *param;
   }
    ...
    shared_ptr<double[]> getPrevDerivative() const{
